<?php
	...
	Class fieldSelectBox_Link_Combo extends fieldSelectBox_Link{
		...
		public function commit(){
			...
			$this->createSectionAssociation(NULL, $id, $this->get('relation_field_id'), $this->get('show_association') == 'yes' ? true : false);
		...
		public function displaySettingsPanel(&$wrapper, $errors=NULL){
			...
			$sections = $sm->fetch(NULL, 'ASC', 'sortorder');
		...
		protected function appendRelationSelect(XMLElement &$wrapper, $field_groups, $errors = null) {
			...
			if(isset($errors['relation_field_id'])) $wrapper->appendChild(Widget::wrapFormElementWithError($label, $errors['relation_field_id']));
			else $wrapper->appendChild($label);
		}
